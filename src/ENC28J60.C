...
void enc28j60Init(unsigned char* macaddr)
{
	...
	while((enc28j60ReadOp(ENC28J60_READ_CTRL_REG, ESTAT) & ESTAT_CLKRDY) == 0)
	...
	// 1 = 符合格式匹配条件的数据包将被接受
	// 0 = 禁止过滤器
	enc28j60Write(ERXFCON, ERXFCON_UCEN|ERXFCON_CRCEN|ERXFCON_PMEN|/*ERXFCON_MCEN|*/ERXFCON_BCEN);
	...
	enc28j60WriteOp(ENC28J60_WRITE_CTRL_REG, EIE, 0);//EIE_INTIE|EIE_PKTIE);
